...
public class BaseDao <T extends BaseEntity> implements Serializable {
	...
	@SuppressWarnings("unchecked")
	public List<ResultDto> executeQuery(String queryStr, String[] columns, Map<String, Object> params) {
	...
	@SuppressWarnings("unchecked")
	public List<ResultDto> executeNativeQuery(String queryStr, String[] columns, Map<String, Object> params) {
