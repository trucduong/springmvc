...
public class NumberFormatter implements Formatter<Number> {
	...
	public static NumberFormatter A(Locale locale, char... separators) {
		String pattern = A;
	...
	public static NumberFormatter B(Locale locale, char... separators) {
		String pattern = B;
		if (separators != null && separators.length > 0) {
	...
	public static NumberFormatter C(Locale locale, char... separators) {
		String pattern = C;
		if (separators != null && separators.length > 0) {
	...
	public static NumberFormatter D(Locale locale, char... separators) {
		String pattern = D;
		if (separators != null && separators.length > 0) {
	...
	public static NumberFormatter E(Locale locale, char... separators) {
		String pattern = E;
		if (separators != null && separators.length > 0) {
	...
	public static NumberFormatter COMMA_SEPERATED(Locale locale, char... separators) {
	...
	public static NumberFormatter CA(Locale locale, char... separators) {
		String pattern = CA;
		if (separators != null && separators.length > 0) {
	...
	public static NumberFormatter CB(Locale locale, char... separators) {
		String pattern = CB;
		if (separators != null && separators.length > 0) {
